...
#else
real,pointer :: rcav(:)       ! accumulated convective precipitation since last chem call
real,pointer :: rnav(:)       ! accumulated ls precipitation since last chem call
#endif
...
! integer, allocatable :: indx(:), map(:)
  ...
  real :: p_gocart (56)          ! list of gocart pressure levels (module_chem_constants)

  public

end module chem_vars_mod
